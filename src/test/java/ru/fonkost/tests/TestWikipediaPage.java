...
public class TestWikipediaPage {
	...
	PersonPage page = PersonPage.createPersonPage(driver, "https://ru.wikipedia.org/wiki/Владимир_Александрович");
     ...
     * <li>Урл с существующим "якорем", но пустым текстовым содержимым элемента
     * с идентификатором, равным "якорю": имя равно наименованию страницы</li>
     * </ul>
     */
    @Test
    public void testGetName() throws Exception {
	PersonPage page = PersonPage.createPersonPage(driver,
		"https://ru.wikipedia.org/wiki/Дети_Михаила_Фёдоровича#.D0.A1.D0.BE.D1.84.D1.8C.D1.8F");
	Person person = page
	...
	person = page.getPerson(
		"https://ru.wikipedia.org/wiki/%D0%91%D0%B5%D0%BB%D0%BE%D0%B7%D0%B5%D1%80%D1%81%D0%BA%D0%B8%D0%B5_%D0%BA%D0%BD%D1%8F%D0%B7%D1%8C%D1%8F#.D0.94.D0.B5.D0.BC.D1.8C.D1.8F.D0.BD_.D0.93.D0.BB.D0.B5.D0.B1.D0.BE.D0.B2.D0.B8.D1.87");
	assertTrue(person.getName().equals("Белозерские князья"));
    }
	...
	PersonPage page = PersonPage.createPersonPage(driver, "https://ru.wikipedia.org/wiki/Рюрик");
